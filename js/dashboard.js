...
! function(t) {
    ...
    window.tram = function(t) {
        ...
        if (R.transition) {
            var M = R.timing.dom;
            if (L.style[M] = f["ease-in-back"][0], !L.style[M])
        ...
        var N = e.frame = function() {
            ...
            j = l(function(e) {
                ...
                function h(t, e, i) {
                    var o, a, s, u, c = e !== p,
                        l = {};
                    for (o in t) s = t[o], o in Y ? (l.transform || (l.transform = {}), l.transform[o] = s) : (w.test(o) && (o = n(o)), o in K ? l[o] = s : (u || (u = {}), u[o] = s));
                    for (o in l) {
                ...
                e.init = function(e) {
                    ...
                    R.backface && B.hideBackface && Z(this.el, R.backface.css, "hidden")
            ...
            q = l($, function(t, e) {
                ...
                t.init = function() {
                    e.init.apply(this, arguments), this.current || (this.current = {}, Y.perspective && B.perspective && (this.current.perspective = B.perspective, Z(this.el, this.name, this.style(this.current)), this.redraw()))
                }, t.set = function(t) {
            ...
            U = l(function(e) {
                function n() {
                    ...
                    if (r)
                        for (N(n), e = I(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
                ...
                e.init = function(t) {
                    ...
                    var t;
                    this.active || (this.start || (this.start = I()), this.active = !0, t = this, 1 === u.push(t) && N(n))
                }, e.stop = function() {
                    var e, n, i;
        ...
        R.transform && (K.transform = [q], Y = {
            ...
            skewX: [k],
            skewY: [k]
        }), R.transform && R.backface && (Y.z = [x, "translateZ"], Y.rotateZ = [k], Y.scaleZ = [g], Y.perspective = [y]);
        var Q = /ms/,
            V = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    n(4), n(7), n(8), n(9), n(10), n(11), n(12), n(13), n(14), t.exports = n(17)
}, function(t, e, n) {
    "use strict";
    var i = n(0);
    ...
    i.define("dropdown", t.exports = function(t, e) {
        ...
        function L() {
            n = f && i.env("design"), (u = O.find(p)).each(T)
        }
        ...
        function T(e, r) {
            ...
            l || (l = t.data(r, p, {
                ...
                return function() {
                    t.hovering = !1, t.links.is(":focus") || M(t)
                }
            }(l), l.mouseUpOutside = function(e) {
                e.mouseUpOutside && O.off(_, e.mouseUpOutside);
                return c(function(n) {
                    if (e.open) {
                        var r = t(n.target);
            ...
            var d = l.toggle.attr("id"),
                h = l.list.attr("id");
            d || (d = "w-dropdown-toggle-" + e), h || (h = "w-dropdown-list-" + e), l.toggle.attr("id", d), l.toggle.attr("aria-controls", h), l.toggle.attr("aria-haspopup", "menu"), l.toggle.attr("aria-expanded", "false"), l.toggle.find(".w-icon-dropdown-toggle").attr("aria-hidden", "true"), "BUTTON" !== l.toggle.prop("tagName") && (l.toggle.attr("role", "button"), l.toggle.attr("tabindex") || l.toggle.attr("tabindex", "0")), l.list.attr("id", h), l.list.attr("aria-labelledby", d), l.links.each(function(t, e) {
                e.hasAttribute("tabindex") || e.setAttribute("tabindex", "0"), s.test(e.hash) && e.addEventListener("click", M.bind(null, l))
            }), l.el.off(p), l.toggle.off(p), l.nav && l.nav.off(p);
            var m = C(l, a);
            n && l.el.on(A, function(t) {
                return function(e, n) {
                    n = n || {}, S(t), !0 === n.open && R(t), !1 === n.open && M(t, {
                        immediate: !0
                    })
                }
            }(l)), n || (f && (l.hovering = !1, M(l)), l.config.hover && l.toggle.on(y, function(t) {
                return function() {
                    t.hovering = !0, R(t)
                }
                ...
                return function(e) {
                    if (!n && t.open) switch (t.selectedIdx = t.links.index(document.activeElement), e.keyCode) {
                        ...
                        case o.ESCAPE:
                            return M(t), t.toggle.focus(), e.stopPropagation();
                        case o.ARROW_RIGHT:
                        case o.ARROW_DOWN:
                ...
                return c(function(e) {
                    ...
                    return o || M(t), e.stopPropagation()
                })
        ...
        function C(t, e) {
            return c(function(n) {
                if (t.open || n && "w-close" === n.type) return M(t, {
                    forceClose: e
                });
                R(t)
            })
        ...
        function R(e) {
            if (!e.open) {
                ...
                }(e), e.open = !0, e.list.addClass(v), e.toggle.addClass(v), e.toggle.attr("aria-expanded", "true"), m.intro(0, e.el[0]), i.redraw.up(), e.manageZ && e.el.css("z-index", w + 1);
                var r = i.env("editor");
                n || O.on(_, e.mouseUpOutside), e.hovering && !r && e.el.on(k, e.mouseLeave), e.hovering && r && O.on(x, e.mouseMoveOutside), window.clearTimeout(e.delayId)
            }
        }
        ...
        function M(t) {
            ...
            if (t.open && (!t.config.hover || !t.hovering || i)) {
                ...
                var r = t.config;
                if (m.outro(0, t.el[0]), O.off(_, t.mouseUpOutside), O.off(x, t.mouseMoveOutside), t.el.off(k, t.mouseLeave), window.clearTimeout(t.delayId), !r.delay || n) return t.complete();
        ...
        return l.ready = L, l.design = function() {
            d && O.find(p).each(function(e, n) {
